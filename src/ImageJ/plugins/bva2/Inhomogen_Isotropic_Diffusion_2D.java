 ...
 * written by Jan-Friedrich Ehlenbr�ker, Alexander Maier, Uwe M�nks, Stefan     *
...
public class Inhomogen_Isotropic_Diffusion_2D implements PlugInFilter {
    ...
    private void gui(ImageProcessor ip) {
        ...
        gd.addPanel(bild);
        gd.addMessage("Copyright (c) 2006\nJan-Friedrich Ehlenbr�ker, Alexander " +
                "Maier,\nUwe M�nks, Stefan Schwalowsky, Matthias Tobergte");
